    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ url('/admin/pages') }}"><i class="fa fa-files-o text-aqua"></i>Pages</a></li>
                    <li><a href="{{ url('/admin/new-pages') }}"><i class="fa fa-plus-circle text-aqua"></i>Add
                        Page</a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ url('/admin/team') }}"><i class="fa fa-list text-aqua"></i>Team</a></li>
                    <li><a href="{{ url('/admin/new-member') }}"><i class="fa fa-plus-square text-aqua"></i>Add New Member</a></li>
                </ul>
            </li>
