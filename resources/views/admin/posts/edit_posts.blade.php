            ...
            <div class="col-xs-12 col-md-12">
                <div class="box box-success">
                    ...
                    <form role="form" enctype="multipart/form-data" name="edit_post" id="edit_post" method="POST"
                        action="{{ url('/admin/post/'.$posts->id.'/edit') }}">
                        {{ csrf_field() }}
                                    ...
                                    <div class="col-xs-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="post_title" class="form-control"
                                                placeholder="Post Title" value="{{ $posts->title }}">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-md-12">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                placeholder="Post Url" value="{{ $posts->url }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="cat_description"
                                                class="form-control my-editor" cols="30" rows="5">{{ $posts->content }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
