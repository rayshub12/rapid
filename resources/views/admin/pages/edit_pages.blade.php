            ...
            <div class="col-xs-12 col-md-12">
                <div class="box box-success">
                    ...
                    <form role="form" enctype="multipart/form-data" name="edit_post" id="edit_post" method="POST"
                        action="{{ url('/admin/page/'.$pages->id.'/update') }}">
                        {{ csrf_field() }}
                                    ...
                                    <div class="col-xs-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="post_title" class="form-control"
                                                placeholder="Post Title" value="{{ $pages->title }}">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="sub_title" id="sub_title"
                                                class="form-control" cols="30" rows="3">{{ $pages->sub_title }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-md-12">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                placeholder="Post Url" value="{{ $pages->url }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="cat_description"
                                                class="form-control my-editor" cols="30" rows="5">{{ $pages->content }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <select name="template_type" id="template_type" class="form-control">  
                                                <option value="1" @if($pages->template_type == '1') selected @endif>Statnderd</option>
                                                <option value="2" @if($pages->template_type == '2') selected @endif>Sidebar</option>
                                    ...
                                    <div class="col-xs-12 col-md-12">
                                        <div class="form-group">
                                            <label>
                                                <input name="contact_form" id="form_1" type="checkbox" class="flat-green" value="1" @if($pages->contact_form == '1') checked @endif> Contact form &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <input name="career_form" id="form_2" type="checkbox" class="flat-green" value="2" @if($pages->career_form == '1') checked @endif> Career form
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-md-12">
                                    ...
                                    <div class="col-xs-12 col-md-12 col-lg-12">
                                        ...
                                        <p><img width="200" src="{{ url('/images/frontend/page_images/large/'.$pages->page_image) }}" alt=""></p>
                                    </div>
