                    ...
                    <div class="probox">
                        <a href="<?php echo e(url('/properties/'.$p->reference)); ?>">
                            ...
                            <div class="pro_con">
                                ...
                                <a class="badge badge-warning badge-sm" href="#"><?php echo e($p->t_name); ?></a>
                                <?php endif; ?>
    ...
    <div class="d-sm-flex flex-row">
        <div class="flex-fill">
            <div class="countrybox">
                ...
                <a href="<?php echo e(url('/property/are.0.5/ajman')); ?>">
        ...
        <div class="flex-fill">
            <div class="countrybox">
                ...
                <a href="<?php echo e(url('/property/are.0.1/dubai')); ?>">
                    <span class="count_overlay"></span>
        ...
        <div class="flex-fill">
            <div class="countrybox">
                ...
                <a href="<?php echo e(url('/property/are.0.4/sharjah')); ?>">
                    <span class="count_overlay"></span>
        ...
        <div class="flex-fill">
            <div class="countrybox">
                ...
                <a href="<?php echo e(url('/property/are.0.6/abu-dhabi')); ?>">
                    <span class="count_overlay"></span>
...
<?php echo $__env->make('layouts.frontend.home_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GIT_Code\rapid\resources\views/homepage.blade.php ENDPATH**/ ?>