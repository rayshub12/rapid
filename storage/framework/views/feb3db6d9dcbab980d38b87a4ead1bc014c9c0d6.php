...
<div id="smart_container">
    ...
    <section class="prop_detailsinfo">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="prop_table <?php if($property->property_for == 3): ?> d-none <?php endif; ?>">
                        <h5>FACTS</h5>
                        <table class="table-responsive table table-bordered ">
                            <tbody>
                                <tr>
                                    <td scope="row">Price</td>
                                    <td><?php if($property->property_for == 2): ?>
                                        AED <?php echo e($property->property_price); ?>

                                        <?php elseif($property->property_for == 1): ?> 
                                        AED <?php echo e($property->property_price); ?> 
                                        <?php endif; ?></td>
                                </tr>
                                <tr>
                                    <td scope="row">Type</td>
                                    <td><?php if(!empty($property->property_type)): ?><?php echo e($property->property_type); ?><?php endif; ?></td>
                                </tr>
                                <tr>
                                    <td scope="row">Property Code</td>
                                    <td><?php if(!empty($property->property_code)): ?><?php echo e($property->property_code); ?><?php endif; ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php if($property->furnish_type == 'F'): ?> Full Furnished <?php elseif($property->furnish_type == 'U'): ?> Unfurnished <?php elseif($property->furnish_type == 'S'): ?> Semi-Furnished <?php endif; ?></td>
                                </tr>
                                <tr>
                                    <td scope="row">Area</td>
                                    <td><?php if(!empty($property->property_area)): ?><?php echo e($property->property_area); ?> sqft. <?php endif; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="prop_table <?php if($property->property_for == 3): ?> d-none <?php endif; ?>">
                        ...
                        <div class="amenties">
                            <ul>
                            <?php if(!empty($property->am)): ?>
                                <?php $__currentLoopData = $property->am; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $am): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><?php echo e($am->name); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                            <?php if(!empty($property->amenities)): ?>
                            <?php $__currentLoopData = explode(',', $property->amenities); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $am): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $__currentLoopData = \App\Amenity::where('amenity_code', $am)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><?php echo e($amn->name); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                            <?php endif; ?>
                ...
                <div class="col-md-3">
                    <div class="probox">
                        <a href="<?php echo e(url('/properties/'.$prel->id)); ?>">
                            ...
                            <div class="pro_con">
                                <h5><?php echo e(str_limit($prel->location->community, $limit=13)); ?>, <?php echo e($prel->location->city); ?></h5> 
                                <a class="badge badge-warning badge-sm" href="<?php echo e(url('/properties/'.$prel->type->name)); ?>">
                                    <?php echo e($prel->type->name); ?>

                                </a>
                                <p><?php echo e($prel->languages[0]->title); ?></p>
                                <h6><?php if($prel->price->offering_type == 'rent'): ?>AED <?php echo e($prel->price->prices[0]->value); ?> <span>/<?php echo e($prel->price->prices[0]->period); ?></span><?php elseif($prel->price->offering_type == 'sale'): ?> AED <?php echo e($prel->price->value); ?> <?php endif; ?></h6>
                                <ul>
                                    <?php if(!empty($prel->bedrooms)): ?><li><img src="<?php echo e(url('images/frontend/images/bedroom.svg')); ?>"><?php echo e($prel->bedrooms); ?>
...
<?php echo $__env->make('layouts.frontend.home_design_2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/b81baw0coev3/public_html/rapidleads.buzzsummo.net/resources/views/frontend/property/single_property.blade.php ENDPATH**/ ?>