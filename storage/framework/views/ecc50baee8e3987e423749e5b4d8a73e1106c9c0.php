    ...
    <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(url('/images/frontend/images/logo.svg')); ?>" alt="<?php echo e(config('app.name')); ?>"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(url('/property-for/off-plan')); ?>">OFF PLAN</a>
                </li>
...
</header><?php /**PATH D:\rapid deals\server code\resources\views/layouts/frontend/home_header.blade.php ENDPATH**/ ?>