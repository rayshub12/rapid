            ...
            <div class="col-xs-12 col-md-8">
                <div class="box box-success">
                    ...
                    <form role="form" enctype="multipart/form-data" name="add_banner" id="add_banner" method="POST"
                        action="<?php echo e(url('/admin/new-banners')); ?>">
...
<?php echo $__env->make('layouts.backend.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/b81baw0coev3/public_html/rapidleads.buzzsummo.net/resources/views/admin/setting/banners/add_banner.blade.php ENDPATH**/ ?>