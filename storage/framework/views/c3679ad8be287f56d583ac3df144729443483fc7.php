                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="owl-carousel blog-carousel work-class1" id="work-class1">
                            <?php $__currentLoopData = \App\Post::orderBy('created_at', 'desc')->where('status','1')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="owl-carousel work-class2" id="work-class2">
                            <?php $__currentLoopData = \App\Post::orderBy('created_at', 'desc')->where('status','1')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item">
                                <div class="blog_txt">
