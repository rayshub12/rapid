                    ...
                    <div class="tab-pane fade show active" id="buy" role="tabpanel" aria-labelledby="buy-tab">
                        <form action="<?php echo e(url('/search-result')); ?>" method="post">
                            <div class="search_input">
                                ...
                                asort($a);
                                ?>
                                <select class="selectpicker form-control" name="location_id" id="number" data-container="body" data-live-search="true" title="Select a number" data-hide-disabled="true">
    ...
    <section class="property_sec">
        <div class="container">
            ...
            <div class="product-carousel owl-carousel owl-theme">
                ...
                <?php if($p->property_for == 1): ?>
                <?php $counter++ ?>
                <?php if($counter <= 8): ?> <div class="item">
                    <div class="probox">
                        <a href="<?php echo e(url('/properties/'.$p->id)); ?>">
                            <span
                                class="tag_top <?php if($p->property_for == 2): ?> rent <?php elseif($p->property_for == 1): ?> buy <?php endif; ?>">
                                <?php if($p->property_for == 2): ?> Rent <?php elseif($p->property_for == 1): ?> Buy <?php endif; ?>
                            </span>
                            <div class="pro_img">
                                ...
                                <img height="289" src="<?php echo e($p->images[0]->medium->link); ?>">
                                <?php else: ?>
                            ...
                            <div class="pro_con">
                                ...
                                <?php if(!empty($p->property_type)): ?>
                                    <a class="badge badge-warning badge-sm" href="#"><?php echo e($p->property_type); ?></a>
                                <?php endif; ?>
                                <p><?php echo e($p->name); ?></p>
                                <ul>
                                    <?php if(!empty($p->bedrooms)): ?><li><img src="<?php echo e(url('images/frontend/images/bedroom.svg')); ?>"><?php echo e($p->bedrooms); ?>

                                    </li><?php endif; ?>
                                    <?php if(!empty($p->bathrooms)): ?><li><img src="<?php echo e(url('images/frontend/images/bathroom.svg')); ?>"><?php echo e($p->bathrooms); ?>
        ...
        <div class="product-carousel owl-carousel owl-theme">
            <?php $counter = 0; ?>
            <?php $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($p->property_for == 2): ?>
            <?php $counter++ ?>
            <?php if($counter <= 8): ?> <div class="item">
                <div class="probox">
                    <a href="<?php echo e(url('/properties/'.$p->id)); ?>">
                        <span class="tag_top <?php if($p->property_for == 2): ?> rent <?php elseif($p->property_for == 1): ?> buy <?php endif; ?>">
                            <?php if($p->property_for == 2): ?> Rent <?php elseif($p->property_for == 1): ?> Buy <?php endif; ?>
                        </span>
                        <div class="pro_img">
                            <?php if(!empty($p->image_name)): ?>
    ...
    <div class="d-sm-flex flex-row">
        <div class="flex-fill">
            <div class="countrybox">
                ...
                <a href="<?php echo e(url('/property/48003/al-quoz')); ?>">
        ...
        <div class="flex-fill">
            <div class="countrybox">
                ...
                <a href="<?php echo e(url('/property/47987/dubai-city')); ?>">
                    <span class="count_overlay"></span>
        ...
        <div class="flex-fill">
            <div class="countrybox">
                ...
                <a href="<?php echo e(url('/property/48008/hatta')); ?>">
                    <span class="count_overlay"></span>
        ...
        <div class="flex-fill">
            <div class="countrybox">
                ...
                <a href="<?php echo e(url('/property/48064/arjan')); ?>">
                    <span class="count_overlay"></span>
...
<?php echo $__env->make('layouts.frontend.home_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/b81baw0coev3/public_html/rapidleads.buzzsummo.net/resources/views/homepage.blade.php ENDPATH**/ ?>