                        ...
                        <div class="property_list" id="pro">
                            ...
                            <div class="proplist">
                                ...
                                <div class="proplist_item">
                                    <div class="pro_con">
                                        <label
                                            class="badge badge-warning"><?php echo e($p->t_name); ?></label>
...
<?php echo $__env->make('layouts.frontend.home_design_2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GIT_Code\rapid\resources\views/frontend/property/property_category.blade.php ENDPATH**/ ?>