...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h3><a href="<?php echo e(url('admin/add-amenities')); ?>" class="label label-lg label-success">Add New</a></h3>
        <ol class="breadcrumb">
...
<?php echo $__env->make('layouts.backend.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GIT_Code\RapidDeals\resources\views/admin/property/amenities.blade.php ENDPATH**/ ?>