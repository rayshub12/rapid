                                        ...
                                        <div class="col-xs-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="property_type" id="PropertyType" class="form-control"
                                                    ...
                                                    <option value="<?php echo e($ptype->type_code); ?>">
                                            ...
                                            <div class="form-group">
                                                <label>
                                                    <input type="checkbox" name="amenity[]"
                                                        ...
                                                        class="flat-green" value="<?php echo e($a->amenity_code); ?>"> <?php echo e($a->name); ?>
...
<?php echo $__env->make('layouts.backend.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/b81baw0coev3/public_html/rapidleads.buzzsummo.net/resources/views/admin/property/add_property.blade.php ENDPATH**/ ?>