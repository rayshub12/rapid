...
<div class="inner_banner" style="background-image:url(<?php echo e(url('images/frontend/page_images/large/'.$p->page_image)); ?>);">
    ...
    <section class="all_blogs">
      <div class="container">
        <div class="row">
            <div class="col-lg-12">
              <p class="mb-3"><?php echo $p->content; ?></p>
              </div>
          <div class="col-lg-6 m-auto">
            
            <?php if( $p->career_form == 1 ): ?>
...
<?php echo $__env->make('layouts.frontend.home_design_2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/b81baw0coev3/public_html/rapidleads.buzzsummo.net/resources/views/frontend/pages/single_page_template_2.blade.php ENDPATH**/ ?>