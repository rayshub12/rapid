                        ...
                        <table id="allusers-table" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a target="_blank" href="<?php echo e(url($p->url)); ?>"><strong><?php echo e($p->title); ?></strong></a></td>
...
<?php echo $__env->make('layouts.backend.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\rapid deals\server code\resources\views/admin/pages/pages_all.blade.php ENDPATH**/ ?>